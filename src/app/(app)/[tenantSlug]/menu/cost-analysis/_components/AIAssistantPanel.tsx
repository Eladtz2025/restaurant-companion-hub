...
import { generateRecipeBOM, type GenerateRecipeBOMResult } from '@/lib/actions/ai-recipe';
        ...
        <div className="rounded-md border p-3">
          ...
          <div className="flex flex-row-reverse gap-2">
            <IfRole
              ...
              fallback={
                <span className="text-muted-foreground text-xs">אין לך הרשאה ליצור מתכונים</span>
              }
            >
